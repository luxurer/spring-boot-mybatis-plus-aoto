...
import static com.util.PicToPdfUtil.toPdf;
...
public class OtherTest {
	...
	public void excuteToPdf(String path) {
		...
		for (int i = 0; i < tempList.length; i++) {
			if (tempList[i].isDirectory()) {
				...
				toPdf(absolutePath + "/", name);
				excuteToPdf(absolutePath);
				System.out.println("生成 " + num++ + " 次!");
			}
		}
	}
	...
	public void test3() throws Exception {
		String s = "C:/凭证/a/";
		String s1 = ReplacementInfo(s, "凭证", "", "_Generate");
